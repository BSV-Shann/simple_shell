 ...
 * @line: a character pointer that reps the directory path
 */
...
/**
 * exit_b - exists the shell and frees allocated resources
...
/**
 * check_built_ins - determines the appropriate function for execution
 * @str: name of function needed
 * Return: 0 if the function is found, -1 otherwise
 */
 ...
 * @command:array of arguments passed to the shell
 * @line:input string from the user
 * Return: 0 if the function is found, -1 otherwise
 */
